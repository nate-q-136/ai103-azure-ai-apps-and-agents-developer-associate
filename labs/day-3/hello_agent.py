...
PROJECT_ENDPOINT = "https://lqnhat136-8220-resource.services.ai.azure.com/api/projects/lqnhat136-8220"
...
response1 = openai.responses.create(conversation=conversation.id,
...
response2 = openai.responses.create(conversation=conversation.id,
